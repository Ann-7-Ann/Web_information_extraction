...
This project uses **Scrapy** to scrape the website and extract analogous information. It loops through `<p>` tags in the details section and captures corresponding labels and logo image URL.  
